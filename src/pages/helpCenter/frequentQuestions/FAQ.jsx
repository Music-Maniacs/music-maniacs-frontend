...
export const FAQ = () => {
  return (
    <div>
      ...
      <Paragraph as={'ol'}>
        <li>
          Pasión por la Música en Vivo: Valoramos la pasión compartida por la música en vivo. La música es el corazón de
          nuestra comunidad, y celebramos la diversidad de géneros y artistas.
        </li>
        <li>
      ...
      <Paragraph as={'ol'}>
        <li>
          ...
          grupos de personas marginadas o vulnerables. Todos tienen el derecho de utilizar MusicManiacs sin experimentar
          acoso, abuso ni recibir amenazas de violencia. Se prohibirán los contenidos que inciten a la violencia o
          promuevan odio sobre la base de la identidad o vulnerabilidad.
        </li>
        <li>
          Publica contenido auténtico y no hagas trampas ni manipules los contenidos (incluyendo spamming, manipulación
          de videos, contenido ilegítimo), ni interfieras o perturbes la comunidad de alguna otra forma.
        </li>
        <li>
