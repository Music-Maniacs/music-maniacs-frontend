...
export const Index = () => {
  const { isFormModalOpen, openFormModal, closeFormModal, pagination, setPagination, setIsFormEdit, setArtistToEdit } =
    useArtists();
  ...
  return (
    <MMContainer maxWidth="xxl">
      <MMBox className="admin-box-container">
        ...
        <MMModal isModalOpen={isFormModalOpen} closeModal={closeFormModal} maxWidth="lg" title="Crear Artista">
          <Form />
        </MMModal>
